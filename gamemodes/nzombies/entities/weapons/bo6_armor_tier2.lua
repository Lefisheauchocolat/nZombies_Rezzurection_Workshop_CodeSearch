...
SWEP.WorldModel = "models/hari/props/armor_tier2.mdl"
SWEP.HoldType = "slam"
	...
	[ACT_VM_DRAW] = {
		...
		{ ["time"] = 55 / 55, ["type"] = "lua", value = function(self)
			...
			timer.Simple(0, function() 
				...
				ply:StripWeapon("bo6_armor_tier2")
				ply:SetUsingSpecialWeapon(false)
				ply:EquipPreviousWeapon()
				if ply.ArmorType != 3 then
					ply.ArmorType = 2
				end
...
function SWEP:Equip(ply, ...)
	ply:SelectWeapon("bo6_armor_tier2")
