...
--[Model]--
SWEP.ViewModel = "models/nzr/2024/perks/bo3/banana/vm_perk_nana.mdl"
SWEP.ViewModelFOV = 65
SWEP.WorldModel = "models/nzr/2024/perks/bo3/banana/world/wm_perk_nana.mdl"
SWEP.HoldType = "slam"
...
{ ["time"] = 1 / 30, ["type"] = "sound", ["value"] = Sound("Perks_NANA.Raise") },
{ ["time"] = 20 / 30, ["type"] = "sound", ["value"] = Sound("Perks_NANA.Chomp") },
{ ["time"] = 25 / 30, ["type"] = "lua", value = function(self) self:GetOwner():PerkBlur(0.8) end, client = false, server = true},
{ ["time"] = 32 / 30, ["type"] = "sound", ["value"] = Sound("Perks_NANA.Toss") },
},
}
