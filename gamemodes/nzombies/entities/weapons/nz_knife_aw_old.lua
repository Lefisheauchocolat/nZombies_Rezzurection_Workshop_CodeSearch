...
SWEP.Category = "OLD nZombies Knives"
SWEP.Spawnable = false
SWEP.AdminSpawnable = true
SWEP.UseHands = true
SWEP.Type_Displayed = "Melee"
SWEP.Author = "GhostlyMoo"
SWEP.Slot = 0
SWEP.PrintName = "Tactical Knife (AW)"
...
--[Gun Related]--
SWEP.Primary.Sound = "nz_moo/zombies/vox/mute_00.wav"
SWEP.Primary.Sound_Hit = "TFA.WAW.KNIFE.Hit"
SWEP.Primary.Sound_HitFlesh = "TFA_MOO_AW_KNIFE.STAB"
...
SWEP.SequenceRateOverride = {
  [ACT_VM_MISSCENTER] = 0.85,
}

SWEP.EventTable = {
	[ACT_VM_HITCENTER] = {
		{ ["time"] = 0 / 30, ["type"] = "sound", ["value"] = Sound("TFA_MOO_AW_KNIFE.SWING") },
	},
	[ACT_VM_MISSCENTER] = {
		{ ["time"] = 0 / 30, ["type"] = "sound", ["value"] = Sound("TFA_MOO_AW_KNIFE.SWING") },
	},
