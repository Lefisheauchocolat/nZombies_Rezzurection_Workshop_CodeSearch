...
--[Model]--
SWEP.ViewModel = "models/nzr/2025/perks/stim/vm_arc_stimshot.mdl"
SWEP.ViewModelFOV = 65
SWEP.WorldModel = "models/nzr/2025/perks/stim/world/wm_arc_stim.mdl"
SWEP.HoldType = "slam"
...
{ ["time"] = 0, ["type"] = "lua", value = function(self)
	if self:GetOwner():HasUpgrade("speed") then
		self.SequenceRateOverride[ACT_VM_DRAW] = 90 / 60
	else
...
{ ["time"] = 1 / 60, ["type"] = "sound", ["value"] = Sound("Perks_Stim.Raise") },
{ ["time"] = 5 / 60, ["type"] = "sound", ["value"] = Sound("Perks_Stim.Cap_Off") },
{ ["time"] = 11 / 60, ["type"] = "sound", ["value"] = Sound("Perks_Stim.Open") },
{ ["time"] = 30 / 60, ["type"] = "sound", ["value"] = Sound("Perks_Stim.In") },
{ ["time"] = 32 / 60, ["type"] = "sound", ["value"] = Sound("Perks_Stim.Inject") },
{ ["time"] = 32 / 60, ["type"] = "lua", value = function(self) self:GetOwner():PerkBlur(0.8) end, client = false, server = true},
{ ["time"] = 59 / 60, ["type"] = "sound", ["value"] = Sound("Perks_Stim.Prep") },
},
}
