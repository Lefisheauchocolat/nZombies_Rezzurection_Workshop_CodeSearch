...
--[Model]--
SWEP.ViewModel			= "models/weapons/wavy_ports/waw/c_waw_stickgrenade.mdl"
SWEP.ViewModelFOV = 65
SWEP.WorldModel			= "models/weapons/wavy_ports/waw/w_waw_stickgrenade.mdl"
...
SWEP.NZHudIcon = Material("vgui/hud_us_grenade.png", "unlitgeneric smooth")
SWEP.NZHudIcon_t5 = Material("vgui/hud_us_grenade.png", "unlitgeneric smooth")
SWEP.NZHudIcon_t7 = Material("vgui/hud_icon_stielhand_upgraded.png", "unlitgeneric smooth")
SWEP.NZHudIcon_t7tomb = Material("vgui/hud_icon_stielhand_upgraded.png", "unlitgeneric smooth")
SWEP.NZHudIcon_t7zod = Material("vgui/hud_icon_stielhand_upgraded.png", "unlitgeneric smooth")
...
--[Projectiles]--
SWEP.Primary.Round = "nz_waw_stickgrenade_thrown"
SWEP.Primary.ProjectileModel = "models/weapons/wavy_ports/waw/stickgrenade_projectile.mdl"
SWEP.Velocity = 850
...
{ ["time"] = 15 / 45, ["type"] = "sound", ["value"] = Sound("TFA.BO1.M67.Pin") },
},
[ACT_VM_THROW] = {
...
SWEP.WElements = {
	["fakenade"] = { type = "Model", model = "models/weapons/wavy_ports/waw/stickgrenade_projectile.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1.75, -6), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = true, bodygroup = {} },
}
...
function SWEP:GrenadeSwap()
	self.Cookable = true
	self.Primary_TFA.Round = "nz_waw_stickgrenade_thrown"
	self:ClearStatCache("Primary.Round")
end
