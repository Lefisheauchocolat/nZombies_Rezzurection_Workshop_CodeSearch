...
--[Model]--
SWEP.ViewModel = "models/nzr/2024/perks/vangriddy/vm_s4_goblet.mdl"
SWEP.ViewModelFOV = SNDLVL_65dB
SWEP.WorldModel = "models/nzr/2024/perks/vangriddy/world/wm_s4_goblet.mdl"
SWEP.HoldType = "slam"
...
{ ["time"] = 1 / 30, ["type"] = "sound", ["value"] = Sound("Perks_VG.Lift") },
{ ["time"] = 32 / 30, ["type"] = "sound", ["value"] = Sound("Perks_VG.Drink") },
{ ["time"] = 60 / 30, ["type"] = "lua", value = function(self) self:GetOwner():PerkBlur(0.8) end, client = false, server = true},
{ ["time"] = 70 / 30, ["type"] = "sound", ["value"] = Sound("Perks_VG.Toss") },
},
}
