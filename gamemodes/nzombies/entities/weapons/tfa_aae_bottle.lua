...
SWEP.Author = "Latte"
SWEP.Slot = 0
SWEP.PrintName = "Perk Bottle (AAE)"
...
{ ["time"] = 35 / 60, ["type"] = "sound", ["value"] = Sound("Perks_BO4.Drink") },
{ ["time"] = 43 / 60, ["type"] = "sound", ["value"] = Sound("Perks_BO4.Open") },
{ ["time"] = 72 / 60, ["type"] = "sound", ["value"] = Sound("Perks_BO4.Flick") },
{ ["time"] = 102 / 60, ["type"] = "sound", ["value"] = Sound("Perks_CW.Drink") },
{ ["time"] = 133 / 60, ["type"] = "lua", value = function(self) self:GetOwner():PerkBlur(0.8) end, client = false, server = true},
{ ["time"] = 151 / 60, ["type"] = "sound", ["value"] = Sound("Perks_BO4.BreakAAE") },
},
}
