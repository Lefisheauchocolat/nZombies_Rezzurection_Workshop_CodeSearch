...
{ ["time"] = 35 / 30, ["type"] = "sound", ["value"] = Sound("Perks_BO3.Flick") },
{ ["time"] = 50 / 30, ["type"] = "sound", ["value"] = Sound("Perks_BO3.Catch") },
{ ["time"] = 55 / 30, ["type"] = "sound", ["value"] = Sound("Perks_BO3.Chew") },
},
}
...
function SWEP:PreDrawViewModel(...)
	...
	local gumdata = nzGum:GetActiveGumData(self:GetOwner())
	if nzGum.Skins and gumdata then
		vm:SetSubMaterial(0, nzGum.Skins[gumdata.rare or nzGum.RareTypes.DEFAULT][gumdata.type])
		vm:SetSubMaterial(1, "vgui/white")
	end
