...
SWEP.Author = "Latte"
SWEP.Slot = 0
SWEP.PrintName = "Perk Bottle (RENAISSANCE)"
...
--[Model]--
SWEP.ViewModel = "models/nzr/2025/perks/ren/vm_ren_bottle.mdl"
...
{ ["time"] = 15 / 30, ["type"] = "sound", ["value"] = Sound("Perks_T7C.Open") },
{ ["time"] = 30 / 30, ["type"] = "sound", ["value"] = Sound("Perks_Ren.Drink") },
{ ["time"] = 40 / 30, ["type"] = "lua", value = function(self) self:GetOwner():PerkBlur(0.8) end, client = false, server = true},
{ ["time"] = 50 / 30, ["type"] = "sound", ["value"] = Sound("Perks_Ren.Burp") },
{ ["time"] = 60 / 30, ["type"] = "sound", ["value"] = Sound("Perks_T7C.Break") },
},
}
