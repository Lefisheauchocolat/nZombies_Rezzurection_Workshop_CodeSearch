...
SWEP.Author = "Latte"
SWEP.Slot = 0
SWEP.PrintName = "Perk Bottle (WAW)"
...
--[Model]--
SWEP.ViewModel = "models/nzr/2024/perks/waw/vm_t4_perk_bottle.mdl"
SWEP.ViewModelFOV = 70
SWEP.WorldModel = "models/nzr/2024/perks/waw/world/wm_t4_perk_bottle.mdl"
SWEP.HoldType = "slam"
...
{ ["time"] = 15 / 30, ["type"] = "sound", ["value"] = Sound("Perks_BO1.Open") },
{ ["time"] = 30 / 30, ["type"] = "sound", ["value"] = Sound("Perks_BO1.Drink") },
{ ["time"] = 40 / 30, ["type"] = "lua", value = function(self) self:GetOwner():PerkBlur(0.8) end, client = false, server = true},
{ ["time"] = 50 / 30, ["type"] = "sound", ["value"] = Sound("Perks_BO1.Burp") },
{ ["time"] = 60 / 30, ["type"] = "sound", ["value"] = Sound("Perks_BO1.Break") },
},
}
