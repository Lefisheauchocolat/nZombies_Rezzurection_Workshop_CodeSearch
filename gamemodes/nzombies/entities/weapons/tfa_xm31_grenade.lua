...
SWEP.Slot = 5
SWEP.PrintName = "XM-31 Grenade Launcher"
...
--[Model]--
SWEP.ViewModel			= "models/nzr/2024/weapons/xm31/c_xm31.mdl"
SWEP.ViewModelFOV = 70
SWEP.WorldModel			= "models/nzr/2024/weapons/xm31/w_xm31.mdl"
...
--[Projectiles]--
SWEP.Primary.Round = "bo1_m67_grenade"
SWEP.Primary.ProjectileModel = "models/nzr/2024/weapons/frag/w_fragnade.mdl"
SWEP.Velocity = 850
...
--[NZombies]--
SWEP.NZHudIcon = Material("nz_moo/hud_grenade_bo2.png", "unlitgeneric smooth")
SWEP.NZHudIcon_t5 = Material("nz_moo/hud_grenade_bo2.png", "unlitgeneric smooth")
...
[ACT_VM_THROW] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("NZ.BO2.XM31.Fire") },
...
/*SWEP.WElements = {
	["fakenade"] = { type = "Model", model = "models/nzr/2024/weapons/frag/w_fragnade.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 2.5, -1), angle = Angle(180, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = true, bodygroup = {} },
}*/
...
function SWEP:GrenadeSwap()
	//self.Cookable = true
	self.Primary_TFA.Round = "bo1_m67_grenade"
	self:ClearStatCache("Primary.Round")
end
