...
SWEP.Slot = 4
SWEP.PrintName = "Bouncing Betty (Equipment) | W@W"
...
--[Projectiles]--
SWEP.Primary.Round = "nz_waw_tac_bbetty"
...
SWEP.NZHudIcon_t7zod = Material("vgui/icon/hud_zom_bouncing_betty_t7.png", "unlitgeneric smooth")
