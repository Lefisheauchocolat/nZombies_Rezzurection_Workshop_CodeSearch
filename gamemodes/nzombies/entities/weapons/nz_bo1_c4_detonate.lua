...
--[Model]--
SWEP.ViewModel			= "models/weapons/tfa_bo1/c4/c_c4_detonate.mdl"
SWEP.ViewModelFOV = 65
SWEP.WorldModel			= "models/weapons/tfa_bo1/c4/w_c4_detonator.mdl"
SWEP.HoldType = "slam"
...
function SWEP:PreDrawViewModel(vm, ...)
	...
	local wep = ply:GetWeapon("tfa_bo1_c4")

	if IsValid(wep) and wep.Ispackapunched then
...
function SWEP:Equip(ply, ...)
	self:EmitSound("TFA_BO1_C4.Trigger")
