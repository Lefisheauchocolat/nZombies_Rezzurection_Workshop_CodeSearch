...
SWEP.NZHudIcon_t5 = Material("nz_moo/huds/bo4/hud_stick_grenade_bo4.png", "unlitgeneric smooth")
SWEP.NZWidowIcon = Material("nz_moo/huds/bo4/hud_stick_grenade_bo4.png", "unlitgeneric smooth")
SWEP.NZWidowIcon_t5 = Material("nz_moo/huds/bo4/hud_stick_grenade_bo4.png", "unlitgeneric smooth")
SWEP.NZWidowIcon_t7 = Material("nz_moo/huds/t7/uie_t7_zm_hud_inv_widowswine.png", "unlitgeneric smooth")
