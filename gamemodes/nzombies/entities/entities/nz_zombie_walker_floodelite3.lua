...
ENT.Models = {
	{Model = "models/zombies/flood_elite3.mdl", Skin = 0, Bodygroups = {0,0}},
		{Model = "models/zombies/flood_elite3.mdl", Skin = 1, Bodygroups = {0,0}},
			{Model = "models/zombies/flood_elite3.mdl", Skin = 2, Bodygroups = {0,0}},
				{Model = "models/zombies/flood_elite3.mdl", Skin = 3, Bodygroups = {0,0}},
					{Model = "models/zombies/flood_elite3.mdl", Skin = 4, Bodygroups = {0,0}},
						{Model = "models/zombies/flood_elite3.mdl", Skin = 5, Bodygroups = {0,0}},
							{Model = "models/zombies/flood_elite3.mdl", Skin = 6, Bodygroups = {0,0}},
}

local spawnslow = {"resurrect", "transform_a"}



ENT.IdleSequence = "idle1","idle2","idle3", "idle4"
...
local walksounds = {
	Sound("enemies/zombies/flood/elite3/slow1.wav"),
	Sound("enemies/zombies/flood/elite3/slow2.wav"),
	Sound("enemies/zombies/flood/elite3/slow3.wav"),
	Sound("enemies/zombies/flood/elite3/slow4.wav"),
	Sound("enemies/zombies/flood/elite3/slow5.wav"),
	Sound("enemies/zombies/flood/elite3/slow6.wav"),
	Sound("enemies/zombies/flood/elite3/slow7.wav"),
	Sound("enemies/zombies/flood/elite3/slow8.wav"),
	Sound("enemies/zombies/flood/elite3/slow9.wav"),
	Sound("enemies/zombies/flood/elite3/slow10.wav"),
	Sound("enemies/zombies/flood/elite3/slow11.wav"),
	Sound("enemies/zombies/flood/elite3/slow12.wav"),
	Sound("enemies/zombies/flood/elite3/slow13.wav"),
	Sound("enemies/zombies/flood/elite3/slow14.wav"),
...
local runsounds = {
	...
	Sound("enemies/zombies/flood/elite3/slow13.wav"),
	Sound("enemies/zombies/flood/elite3/slow14.wav"),
	Sound("enemies/zombies/flood/elite3/fast1.wav"),
	Sound("enemies/zombies/flood/elite3/fast2.wav"),
	Sound("enemies/zombies/flood/elite3/fast3.wav"),
	Sound("enemies/zombies/flood/elite3/fast4.wav"),
	Sound("enemies/zombies/flood/elite3/fast5.wav"),
	Sound("enemies/zombies/flood/elite3/fast6.wav"),
	Sound("enemies/zombies/flood/elite3/fast7.wav")
}
...
ENT.DeathSounds = {
	"enemies/zombies/flood/elite3/death1.wav",
	"enemies/zombies/flood/elite3/death2.wav",
	"enemies/zombies/flood/elite3/death3.wav",
	"enemies/zombies/flood/elite3/death4.wav",
	"enemies/zombies/flood/elite3/death5.wav",
	"enemies/zombies/flood/elite3/death6.wav",
	"enemies/zombies/flood/elite3/death7.wav",
	"enemies/zombies/flood/elite3/death8.wav",
	"enemies/zombies/flood/elite3/death9.wav",
	"enemies/zombies/flood/elite3/death10.wav",
	"enemies/zombies/flood/elite3/death11.wav",
...
ENT.AttackSounds = {
	"enemies/zombies/flood/elite3/melee1.wav",
	"enemies/zombies/flood/elite3/melee2.wav",
	"enemies/zombies/flood/elite3/melee3.wav",
	"enemies/zombies/flood/elite3/melee4.wav"
