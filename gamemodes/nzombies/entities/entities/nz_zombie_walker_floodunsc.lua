...
ENT.Models = {
	{Model = "models/zombies/flood_soldier.mdl", Skin = 0, Bodygroups = {0,0}},
	--{Model = "models/zombies/flood_elite.mdl", Skin = 0, Bodygroups = {0,0}}
}

local spawnslow = {"wake_up", "wake_up_back"}
local spawnsuperfast = {"flinch_small1"}

ENT.DeathSequences = {
	"death","death_bk", "air_death_land"
}
...
ENT.AttackSounds = {
	"enemies/zombies/flood/melee1.mp3",
	"enemies/zombies/flood/melee2.mp3",
	"enemies/zombies/flood/melee3.mp3",
	"enemies/zombies/flood/melee4.mp3",
	"enemies/zombies/flood/melee5.mp3",
	"enemies/zombies/flood/melee6.mp3",
	"enemies/zombies/flood/melee7.mp3",
	"enemies/zombies/flood/melee8.mp3",
	"enemies/zombies/flood/melee9.mp3",
	"enemies/zombies/flood/melee10.mp3",
