...
if CLIENT then
	ENT.EyeColorTable = {
		[0] = Material("materials/models/moo/codz/codol_zombies/poolday/mtl_zombie_civ_female_a_eyeball.vmt"),
		[1] = Material("materials/models/moo/codz/codol_zombies/poolday/mtl_zombie_tourist_eye.vmt"),
	}
	return 
...
ENT.Models = {
	{Model = "models/moo/_codz_ports/codol/poolday/moo_codz_codol_female_tourist.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/codol/poolday/moo_codz_codol_male_tourist.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/codol/poolday/moo_codz_codol_male_pirate.mdl", Skin = 0, Bodygroups = {0,0}},
}
