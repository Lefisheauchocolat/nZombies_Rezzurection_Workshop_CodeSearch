...
ENT.Models = {
	{Model = "models/zombies/flood_brute.mdl", Skin = 0, Bodygroups = {0,0}},
}

local spawnslow = {"resurrect", "transformation"}


ENT.IdleSequence = "idle1","idle2"
...
local walksounds = {
	Sound("enemies/zombies/flood/brute3/slow1.wav"),
	Sound("enemies/zombies/flood/brute3/slow2.wav"),
	Sound("enemies/zombies/flood/brute3/slow3.wav"),
	Sound("enemies/zombies/flood/brute3/slow4.wav"),
	Sound("enemies/zombies/flood/brute3/slow5.wav"),
	Sound("enemies/zombies/flood/brute3/slow6.wav"),
	Sound("enemies/zombies/flood/brute3/slow7.wav"),
	Sound("enemies/zombies/flood/brute3/slow8.wav"),
	Sound("enemies/zombies/flood/brute3/slow9.wav"),
	Sound("enemies/zombies/flood/brute3/slow10.wav"),
	Sound("enemies/zombies/flood/brute3/slow11.wav"),
	Sound("enemies/zombies/flood/brute3/slow12.wav")


}

local runsounds = {
	Sound("enemies/zombies/flood/brute3/fast1.wav"),
	Sound("enemies/zombies/flood/brute3/fast2.wav"),
	Sound("enemies/zombies/flood/brute3/fast3.wav"),
	Sound("enemies/zombies/flood/brute3/fast4.wav"),
	Sound("enemies/zombies/flood/brute3/fast5.wav"),
	Sound("enemies/zombies/flood/brute3/fast6.wav"),
	Sound("enemies/zombies/flood/brute3/fast7.wav"),
	Sound("enemies/zombies/flood/brute3/fast8.wav"),
	Sound("enemies/zombies/flood/brute3/fast9.wav"),
	Sound("enemies/zombies/flood/brute3/fast10.wav"),
	Sound("enemies/zombies/flood/brute3/fast11.wav"),
	Sound("enemies/zombies/flood/brute3/fast12.wav"),
	Sound("enemies/zombies/flood/brute3/fast13.wav"),
	Sound("enemies/zombies/flood/brute3/fast14.wav"),
	Sound("enemies/zombies/flood/brute3/fast15.wav"),
	Sound("enemies/zombies/flood/brute3/fast16.wav")
}
...
ENT.DeathSounds = {
	"enemies/zombies/flood/brute3/death1.wav",
	"enemies/zombies/flood/brute3/death2.wav",
	"enemies/zombies/flood/brute3/death3.wav",
	"enemies/zombies/flood/brute3/death4.wav",
	"enemies/zombies/flood/brute3/death5.wav",
	"enemies/zombies/flood/brute3/death6.wav",
	"enemies/zombies/flood/brute3/death7.wav",
	"enemies/zombies/flood/brute3/death8.wav",
	"enemies/zombies/flood/brute3/death9.wav",
	"enemies/zombies/flood/brute3/death10.wav",
...
ENT.AttackSounds = {
	"enemies/zombies/flood/brute3/attack1.wav",
	"enemies/zombies/flood/brute3/attack2.wav",
	"enemies/zombies/flood/brute3/attack3.wav",
	"enemies/zombies/flood/brute3/attack4.wav",
	"enemies/zombies/flood/brute3/attack5.wav",
	"enemies/zombies/flood/brute3/attack6.wav",
	"enemies/zombies/flood/brute3/attack7.wav",
	"enemies/zombies/flood/brute3/attack8.wav",
	"enemies/zombies/flood/brute3/attack9.wav",
...
function ENT:HandleAnimEvent(a,b,c,d,e) -- Moo Mark 4/14/23: You don't know how sad I am that I didn't know about this sooner.
	...
	if e == "flood_step" then
		self:EmitSound("enemies/zombies/flood/brute3/step"..math.random(1,11)..".wav", 65, math.random(95,105))
	end
	
	if e == "event_emit step" then
		self:EmitSound("enemies/zombies/flood/brute3/step"..math.random(1,11)..".wav", 65, math.random(95,105))
	end
end
