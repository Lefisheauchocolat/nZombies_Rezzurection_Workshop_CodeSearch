...
ENT.RedEyes = true
ENT.MooSpecialZombie = false
ENT.IsMooSpecial = false

ENT.Models = {
	{Model = "models/wavy_rigs/lethal_necrotics/wavy_zombie_bomber_new.mdl", Skin = 0, Bodygroups = {0,0}},
}
