...
if CLIENT then
	...
	function ENT:DrawEyeGlow()
		...
		local eyeColor = Color(175,255,0)
...
ENT.MinSoundPitch = 50
ENT.MaxSoundPitch = 55

ENT.SoundDelayMin = 8
ENT.SoundDelayMax = 10

ENT.Models = {
	{Model = "models/moo/_codz_ports/codol/hazmat/moo_codz_codol_hazmat_zombie.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/codol/hazmat/moo_codz_codol_hazmat_zombie.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/codol/hazmat/moo_codz_codol_hazmat_zombie.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/codol/hazmat/moo_codz_codol_hazmat_zombie.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/codol/hazmat/moo_codz_codol_hazmat_zombie.mdl", Skin = 0, Bodygroups = {0,0}},
