...
ENT.Models = {
	{Model = "models/bosses/atomic_flounder.mdl", Skin = 0, Bodygroups = {0,0}},
}
	...
	if CurTime() > self.NextShoot then
		if !self:IsAttackBlocked() and self:TargetInRange(500) and !self:TargetInRange(150) then
			self:TempBehaveThread(function(self)
				...
				self:EmitSound("flounder/FLOUNDA_1.mp3",80,100)
