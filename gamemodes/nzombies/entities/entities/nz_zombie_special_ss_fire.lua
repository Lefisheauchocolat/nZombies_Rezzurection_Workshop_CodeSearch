...
function ENT:PostAdditionalZombieStuff()
	...
	if self:TargetInRange(700) and !self:IsAttackBlocked() and self.CanSpit and !self.IsTurned and !nzPowerUps:IsPowerupActive("timewarp") and math.random(3) == 3 then
