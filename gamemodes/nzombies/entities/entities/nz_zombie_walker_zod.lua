...
if CLIENT then 
	ENT.EyeColorTable = {
		[0] = Material("models/moo/codz/t7_zombies/giant/mtl_c_zom_der_zombie_head1u.vmt"),
		[1] = Material("models/moo/codz/t7_zombies/giant/mtl_char_ger_zombie_eyes.vmt"),
		[2] = Material("models/moo/codz/t7_zombies/stalingrad/mtl_char_rus_zombie_eyes.vmt"),
	}
	return 
