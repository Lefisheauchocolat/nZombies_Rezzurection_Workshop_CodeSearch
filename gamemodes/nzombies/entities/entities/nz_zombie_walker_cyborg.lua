...
ENT.Type = "nextbot"
ENT.Category = "Brainz"
ENT.PrintName = "Cyborg"
ENT.Author = "GhostlyMoo"
ENT.Spawnable = true

if CLIENT then 
	ENT.EyeColorTable = {
		[0] = Material("models/moo/codz/codol_zombies/cyborg/mtl_e_zom_arterylight_blue.vmt"),
		[1] = Material("models/moo/codz/codol_zombies/cyborg/mtl_e_zom_breathlight_blue.vmt"),
	}
	return 
...
ENT.Models = {
	{Model = "models/moo/_codz_ports/codol/cyborg/moo_codz_codol_cyborg_garbageman.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/codol/cyborg/moo_codz_codol_cyborg_ger.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/codol/cyborg/moo_codz_codol_cyborg_securityguard.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/codol/cyborg/moo_codz_codol_cyborg_worker.mdl", Skin = 0, Bodygroups = {0,0}},
}
