...
ENT.Models = {
	{Model = "models/wavy/wavy_rigs/kf1/scrake/wavy_zombie_kfscrake.mdl", Skin = 1, Bodygroups = {0,0}},
	{Model = "models/wavy/wavy_rigs/kf1/scrake/wavy_zombie_kfscrake.mdl", Skin = 1, Bodygroups = {0,0}},
	{Model = "models/wavy/wavy_rigs/kf1/scrake/wavy_zombie_kfscrake.mdl", Skin = 1, Bodygroups = {0,0}},
	{Model = "models/wavy/wavy_rigs/kf1/scrake/wavy_zombie_kfscrake.mdl", Skin = 1, Bodygroups = {0,0}},
	{Model = "models/wavy/wavy_rigs/kf1/scrake/wavy_zombie_kfscrake.mdl", Skin = 1, Bodygroups = {0,0}},
	...
	{Model = "models/wavy/wavy_rigs/kf1/scrake/wavy_zombie_kfscrake.mdl", Skin = 1, Bodygroups = {0,0}},
	{Model = "models/wavy/wavy_rigs/kf1/scrake/wavy_zombie_kfscrake.mdl", Skin = 1, Bodygroups = {0,0}},
	{Model = "models/wavy/wavy_rigs/kf1/scrake/wavy_zombie_kfscrakecircus.mdl", Skin = 1, Bodygroups = {0,0}}, --monkey man has a 10% chance of appearing
}
...
if self.loco:GetVelocity():Length2D() < 75 then
            self:TraversalCheck()
        end -- indented correctly lmaojjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj
	if SERVER then
