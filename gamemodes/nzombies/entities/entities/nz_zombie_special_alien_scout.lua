...
if CLIENT then
	...
	ENT.EyeColorTable = {
		[0] = Material("models/moo/codz/iw7_aliens/scout/mtl_alien_goon_body_a_iw7.vmt"),
		[1] = Material("models/moo/codz/iw7_aliens/scout/mtl_alien_brute_eye_iw7.vmt"),
	}
...
ENT.Models = {
	{Model = "models/moo/_codz_ports/iw7/aliens/moo_codz_iw7_alien_scout.mdl", Skin = 0, Bodygroups = {0,0}},
}
	...
	{Threshold = 0, Sequences = {
		{
			...
			MovementSequence = {
				"nz_ai_alien_drone_walk_01",
				"nz_ai_alien_drone_walk_02",
			},
	...
	{Threshold = 36, Sequences = {
		{
			...
			MovementSequence = {
				"nz_ai_alien_drone_run_01_slow",
				"nz_ai_alien_drone_run_02_slow",
				"nz_ai_alien_drone_run_03_slow",
				"nz_ai_alien_drone_run_04_slow",
				"nz_ai_alien_drone_run_05_slow",
			},
	...
	{Threshold = 155, Sequences = {
		{
			SpawnSequence = {spawnfast},
			MovementSequence = {
				"nz_ai_alien_drone_run_01",
				"nz_ai_alien_drone_run_02",
				"nz_ai_alien_drone_run_02_aggressive",
				"nz_ai_alien_drone_run_03",
				"nz_ai_alien_drone_run_04",
				"nz_ai_alien_drone_run_05",
			},
...
function ENT:StatsInitialize()
	if SERVER then
		if nzRound:GetNumber() == -1 then
			...
			self:SetModelScale(math.Rand(1,1.135), 0.001)
