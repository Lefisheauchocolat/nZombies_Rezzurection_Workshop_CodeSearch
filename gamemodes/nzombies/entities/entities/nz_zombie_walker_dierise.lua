...
if CLIENT then 
	ENT.EyeColorTable = {
		[0] = Material("models/moo/codz/t6_zombies/highrise/mtl_c_zom_chinese_zombie_head1_u.vmt"),
		[1] = Material("models/moo/codz/t6_zombies/highrise/mtl_c_zom_chinese_zombie_head3_u.vmt"),
		[2] = Material("models/moo/codz/t6_zombies/highrise/mtl_c_zom_chinese_zombie_head4_u.vmt"),
	}
	return 
...
ENT.Models = {
	{Model = "models/moo/_codz_ports/t6/highrise/moo_codz_t6_highrise_civshorts_1.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t6/highrise/moo_codz_t6_highrise_civshorts_1.mdl", Skin = 1, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t6/highrise/moo_codz_t6_highrise_civshorts_1.mdl", Skin = 2, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t6/highrise/moo_codz_t6_highrise_civshorts_1.mdl", Skin = 3, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t6/highrise/moo_codz_t6_highrise_civshorts_1.mdl", Skin = 4, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t6/highrise/moo_codz_t6_highrise_civshorts_1.mdl", Skin = 5, Bodygroups = {0,0}},

	{Model = "models/moo/_codz_ports/t6/highrise/moo_codz_t6_highrise_scientist_1.mdl", Skin = 0, Bodygroups = {0,0}},
