...
ENT.Models = {
	{Model = "models/wavy_ports/wavy_enemies/fnaf_canon/chica.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/wavy_ports/wavy_enemies/fnaf_canon/bonnie.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/wavy_ports/wavy_enemies/fnaf_canon/foxy.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/wavy_ports/wavy_enemies/fnaf_canon/freddy.mdl", Skin = 0, Bodygroups = {0,0}},
	
	{Model = "models/moo/_codz_ports/t4/moo_codz_t4_ger_honorguard.mdl", Skin = 0, Bodygroups = {0,0}}, --the single nazi in question
