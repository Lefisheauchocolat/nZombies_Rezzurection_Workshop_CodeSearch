...
if CLIENT then
	...
	ENT.EyeColorTable = {
		[0] = Material("models/moo/codz/t10_zombies/zm/mimic/xmaterial_4543634adcd487e.vmt"),
	}
	...
	function ENT:PostDraw()
		if self:IsAlive() and !self:GetIsHidden() then
			...
			if (!self.Draw_FX2 or !IsValid(self.Draw_FX2)) then
				self.Draw_FX2 = CreateParticleSystem(self, "zmb_shock_mimic_aura", PATTACH_POINT_FOLLOW, 12)
			...
			if self.Draw_FX2 or IsValid(self.Draw_FX2) then
				self.Draw_FX2:StopEmission(false, true)
				self.Draw_FX2 = nil
			end
		end
	end
...
ENT.Models = {
	{Model = "models/moo/_codz_ports/t10/zm/moo_codz_t10_mimic.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t10/zm/moo_codz_t10_mimic.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t10/zm/moo_codz_t10_mimic.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t10/zm/moo_codz_t10_mimic.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t10/zm/moo_codz_t10_mimic.mdl", Skin = 0, Bodygroups = {0,0}},
