...
if CLIENT then
	ENT.EyeColorTable = {
		[0] = Material("models/moo/codz/t5_zombies/siber_coast/mtl_c_zom_heads.vmt"),
	}
	return 
...
ENT.Models = {
	{Model = "models/moo/_codz_ports/t5/coast/moo_codz_t5_siber_coast_1.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t5/coast/moo_codz_t5_siber_coast_2.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t5/coast/moo_codz_t5_siber_coast_3.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t5/coast/moo_codz_t5_siber_coast_4.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t5/coast/moo_codz_t5_siber_coast_5.mdl", Skin = 0, Bodygroups = {0,0}},
}
