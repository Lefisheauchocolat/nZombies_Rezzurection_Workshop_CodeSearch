...
ENT.Type = "nextbot"
--ENT.PrintName = "boom boom midgets"
ENT.PrintName = "Elf Bomber"
ENT.Category = "Brainz"
ENT.Author = "Wavy & Loonicity"
ENT.Spawnable = true
...
ENT.Models = {
		{Model = "models/wavy_ports/wavy_enemies/waw/elf_new/elf_new.mdl", Skin = 0, Bodygroups = {0,0}},
}
...
function ENT:StatsInitialize()
	if SERVER then
		...
		self:SetModelScale(0.65, 0.001)
		self.Sprinting = false
		self.Cooldown = CurTime() + 0.01 -- Won't be allowed to explode right after spawning, so they'll attack normally until then.
...
function ENT:PerformDeath(dmgInfo)	
	...
	ParticleEffect("elf_fireworks",self:GetPos(),self:GetAngles(),nil)
	self:Remove()
end
...
function ENT:HandleAnimEvent(a,b,c,d,e) -- Moo Mark 4/14/23: You don't know how sad I am that I didn't know about this sooner.
	...
	if e == "clown_explode" then
		...
		self:EmitSound("kate_enemies/elf_explode/elf_explode.mp3", 500, math.random(95, 105))
