...
ENT.Models = {
	{Model = "models/wavy/wavy_rigs/lethal_necrotics/hl2_infected/wavy_lnr_zombie_kleiner.mdl", Skin = 0, Bodygroups = {0,0}},
}
...
-- R.I.P. iServerOutVibes. The Kleiners have come for his nZ build.
