...
function nzMapping:LoadMapSettings(data)
	...
	print("Theres gonna be a murder")
	print(data.poweruplist)
	...
	if data.zct then nzMapping.Settings.zct = data.zct or nil end
	if data.mutated then nzMapping.Settings.mutated = data.mutated or nil end
	if data.burning then nzMapping.Settings.burning = data.burning or nil end
	...
	nzMapping.Settings.healthmult = data.healthmult == nil and 0.1 or data.healthmult
