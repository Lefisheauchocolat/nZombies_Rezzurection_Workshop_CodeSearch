...
nzPerks:NewPerk("mask", {
	...
	price 			= 1500,
	upgradeprice 	= 2500, 
	desc 			= "Become immune to most hazards and nova gas. oGrenades become noisome.",
...
nzPerks:NewPerk("whoswho", {
	...
	model_classic 	= "models/nzr/2022/machines/chugabud/vending_chugabud.mdl",
	model 			= "models/kate/_codz_ports_props/t7/zm/p7_zm_vending_chugabud/p7_zm_vending_chugabud.mdl",
...
nzPerks:NewPerk("vulture", {
	...
	model 			= "models/kate/_codz_ports_props/t7/zm/p7_zm_vending_vulture_aid/p7_zm_vending_vulture.mdl",
	model_classic 	= "models/nzr/2022/machines/vulture/vending_vulture.mdl",
	model_vg 		= "models/moo/_codz_ports_props/s4/zod/vulture/moo_codz_s4_zm_demonic_fountain_vulture.mdl",
	model_cw 		= "models/moo/_codz_ports_props/t10/t10_zm_machine_vulture/moo_codz_t10_zm_machine_vulture.mdl",
	off_skin = 0,
	on_skin  = 1,
	price 			= 3000,
	upgradeprice 	= 4500, 
...
nzPerks:NewPerk("death", {
	...
	price 			= 2500,
	upgradeprice 	= 5000,
	desc 			= "Deal increased headshot damage. Sixth sense for zombies behind you and through walls. Additional damage to stunned or slowed zombies.",
	desc2 			= "Further increase headshot damage, deal increased damage to bosses. Damage done to stunned or slowed zombies is further increased.",
...
nzPerks:NewPerk("tortoise", {
	...
	desc 			= "Take less damage from backshots and explode when your shield gets broken. Buildables take less damage.",
	desc2 			= "Shield Provided Every Round. Enemies giving backshots to your shield have a chance of being stunned briefly.",
