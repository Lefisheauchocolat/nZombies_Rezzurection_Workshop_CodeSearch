nzTools:CreateTool("zbossspawn", {
	...
	PrimaryAttack = function(wep, ply, tr, data)
		...
		if IsValid(tr.Entity) and tr.Entity:GetClass() == "nz_spawn_zombie_boss" then
			...
			ent = nzMapping:ZedBossSpawn(tr.HitPos,(Angle(0,(ply:GetPos() - tr.HitPos):Angle()[2],0)), nil, data.roundactive, ply)
		end
	...
	interface = function(frame, data)
		...
		local Row3 = DProperties:CreateRow( "Settings", "Round Activation" )
		Row3:Setup( "Integer" )
