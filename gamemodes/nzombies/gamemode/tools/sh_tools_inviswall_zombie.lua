...
if SERVER then
	util.AddNetworkString("nz_InvisWallCreationZobie")
	
	net.Receive("nz_InvisWallCreationZobie", function(len, ply)
...
nzTools:CreateTool("inviswallzombie", {
	displayname = "Invisible Wall Zombie Creator",
	...
	PrimaryAttack = function(wep, ply, tr, data)
		...
		elseif !height then
			...
			net.Start("nz_InvisWallCreationZobie")
