nzTools:CreateTool("zspecialspawn", {
	...
	PrimaryAttack = function(wep, ply, tr, data)
		...
		if IsValid(tr.Entity) and tr.Entity:GetClass() == "nz_spawn_zombie_special" then
			...
			ent = nzMapping:ZedSpecialSpawn(tr.HitPos,(Angle(0,(ply:GetPos() - tr.HitPos):Angle()[2],0)), nil, tobool(data.master), data.spawntype, data.zombietype, data.roundactive, data.spawnchance, ply)
		end
