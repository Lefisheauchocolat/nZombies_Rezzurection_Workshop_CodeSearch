...
function nzRound:GetInitialBossRound()
	self.InitialBossRound = self.InitialBossRound or false
	return self.InitialBossRound
end

function nzRound:EnableInitialBossRound()
	self.InitialBossRound = true
end

function nzRound:DisableInitialBossRound()
	self.InitialBossRound = false
end
