	...
	for _, wep in pairs(plyweptab) do
		...
		if wep.IsTFAWeapon and wep.NZSpecialCategory == "trap" then
			...
			if ammo > 0 and not wep.TrapCanBePlaced then
				...
				draw.SimpleTextOutlined(ammocount, ammo2font, w - 36*scale, h - 86*scale, ammocount == 0 and color_empty or color_white, TEXT_ALIGN_RIGHT, TEXT_ALIGN_BOTTOM, 2, color_black_50)
			end
		end
