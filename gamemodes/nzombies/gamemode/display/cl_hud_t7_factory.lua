...
local color_t7_sparks = Color(255, 150, 0, 255)
local color_t7 = Color(255, 140, 20, 255)
local color_t7_outline = Color(255, 220, 120, 20)

local color_t7_ammo = Color(255, 250, 245, 255)
local color_t7_ammo_outline = Color(255, 220, 120, 20)
...
//t7 hud
local t7_hud_dpad_base = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_dpadbase.png", "unlitgeneric smooth")
local t7_hud_dpad_base_reflect = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_dpadbasereflect.png", "unlitgeneric smooth")
local t7_hud_dpad_base_glow_anim = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_dpadbaseglowanim.png", "unlitgeneric smooth")

local t7_hud_dpad_flash_up = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_dpadmtr_top_flash.png", "unlitgeneric smooth")
local t7_hud_dpad_flash_down = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_dpadmtr_bottom_flash.png", "unlitgeneric smooth")
local t7_hud_dpad_flash_right = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_dpadmtr_right_flash.png", "unlitgeneric smooth")

local t7_hud_ammo_cover = Material("nz_moo/huds/t7_factory/uie_t7_zm_hd_hud_ammo_cover.png", "unlitgeneric smooth")
local t7_hud_ammo_cover_flash = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hd_hud_ammo_cover_flash.png", "unlitgeneric smooth")
local t7_hud_ammo_glow = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_number_glow.png", "unlitgeneric smooth")
...
local t7_hud_ammo_projection_lrg = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_projection_lrg.png", "unlitgeneric smooth")
local t7_hud_ammo_projection_sml = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_projection_small.png", "unlitgeneric smooth")
...
local t7_hud_ammo_p1 = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_projection_p1.png", "unlitgeneric smooth noclamp")
local t7_hud_ammo_p2 = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_projection_p2.png", "unlitgeneric smooth noclamp")
local t7_hud_ammo_p3 = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_projection_p3.png", "unlitgeneric smooth noclamp")
t7_hud_ammo_p1:SetInt("$flags", 128)
t7_hud_ammo_p2:SetInt("$flags", 128)
t7_hud_ammo_p3:SetInt("$flags", 128)

local t7_hud_ammo = {
	[0] = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_noglow_number0.png", "unlitgeneric smooth"),
	[1] = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_noglow_number1.png", "unlitgeneric smooth"),
	[2] = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_noglow_number2.png", "unlitgeneric smooth"),
	[3] = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_noglow_number3.png", "unlitgeneric smooth"),
	[4] = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_noglow_number4.png", "unlitgeneric smooth"),
	[5] = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_noglow_number5.png", "unlitgeneric smooth"),
	[6] = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_noglow_number6.png", "unlitgeneric smooth"),
	[7] = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_noglow_number7.png", "unlitgeneric smooth"),
	[8] = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_noglow_number8.png", "unlitgeneric smooth"),
	[9] = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_noglow_number9.png", "unlitgeneric smooth"),
}
...
local t7_icon_trap_fill = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_icon_mine.png", "unlitgeneric smooth")
local t7_icon_trap = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_icon_mine_inactive.png", "unlitgeneric smooth")
local t7_icon_underbarrel = Material("nz_moo/huds/t7/uie_t7_zm_hud_ammo_icon_wavegun_active.png", "unlitgeneric smooth")
local t7_icon_zmoney = Material("nz_moo/huds/t7_factory/uie_t7_zm_derriese_hud_ammo_z_blue.png", "unlitgeneric smooth")
local t7_icon_grenade_hud = Material("nz_moo/huds/t7/hud_grenadeicon.png", "unlitgeneric smooth")
local t7_icon_gum = Material("nz_moo/huds/t7_factory/uie_t7_zm_hud_ammo_dpadicnbblgm_new.png", "unlitgeneric smooth")
...
net.Receive("nz_points_notification_factory_hd", function()
...
local Circles = {
	[1] = {r = -1, col = Color(255,150,50,100), colb = Color(255,150,50,100), cole = Color(120,0,0,100)},
	[2] = {r = 0, col = Color(255,150,0,200), colb = Color(255,200,0,200), cole = Color(150,50,0,200)},
	[3] = {r = 1, col = Color(255,200,0,255), colb = Color(255,255,150,255), cole = Color(250,100,0,200)},
	[4] = {r = 2, col = Color(255,150,0,200), colb = Color(255,200,0,200), cole = Color(150,50,0,200)},
	[5] = {r = 3, col = Color(255,150,50,100), colb = Color(255,150,50,100), cole = Color(120,0,0,100)},
}
...
local function InventoryHUD_t7()
	...
	for _, wep in pairs(plyweptab) do
		...
		if wep.IsTFAWeapon and wep.NZSpecialCategory == "shield" and wep.NZHudIcon and not wep.ShieldEnabled then
			...
			local custom = false
			if IsValid(wep) and (wep.NZHudIcon_t7tomb or wep.NZHudIcon) then
				icon = wep.NZHudIcon_t7tomb or wep.NZHudIcon
				custom = wep.NZHudIcon_t7tomb
			end
			if not icon or icon:IsError() then
				icon = zmhud_icon_missing
			end
...
local function DoAnimatedHudBits()
	...
	surface.SetDrawColor(ColorAlpha(color_white, math.random(40, 140)))
	surface.DrawTexturedRect(w - 220*scale, h - 255*scale, 128*scale*1.6, 128*scale*1.6)
end
...
local function GunHud_t7()
	...
	if ply:ShouldDrawInventoryHUD() then
		...
		if numspecial > 0 then
			...
			if tacnade and IsValid(tacnade) and tacnade.NZHudIcon then
				icon = tacnade.NZHudIcon_t7factory or tacnade.NZHudIcon_t7tomb or tacnade.NZHudIcon
				custom = tacnade.NZHudIcon_t7factory
			end
		...
		if num > 0 then
			...
			surface.SetDrawColor(color_t7_ammo)
			surface.SetMaterial(icon)
	...
	if IsValid(wep) then
		...
		if class == "nz_multi_tool" then
			draw.SimpleTextOutlined(nzTools.ToolData[wep.ToolMode].displayname or wep.ToolMode, smallfont, w - 230*scale, h - 80*scale, fontColor, TEXT_ALIGN_RIGHT, TEXT_ALIGN_BOTTOM, 1, color_black_50)
			draw.SimpleTextOutlined(nzTools.ToolData[wep.ToolMode].desc or "", ammofont, w - 220*scale, h - 180*scale, color_t7, TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, color_t7_outline)
		elseif (illegalspecials[wep.NZSpecialCategory] and not wep.NZSpecialShowHUD) then
			...
			if wep.Primary then
				...
				local outlineCol = Color(255, 220, 120, 20)
				local reserveoutCol = color_t7_ammo_outline
				local ammoCol = Color(255, 250, 245, 255)
				...
				if clip and clip > 0 then
					...
					surface.SetDrawColor(lowclip and (ColorAlpha(color_white, 100*flashing_sin)) or color_white_100)
					surface.DrawTexturedRect(w - 390*scale, h - 240*scale, 140*scale, 140*scale)

					if ammoType == -1 then
						local xlipoffset = 0
						if cliplen >= 3 then xlipoffset = 10 end
						draw.SimpleText(clip1, dafont, w - (300 - xlipoffset)*scale, h - 130*scale, ammoCol, TEXT_ALIGN_RIGHT, TEXT_ALIGN_BOTTOM, 1, outlineCol)
					else
						draw.SimpleTextOutlined(clip1, dafont, w - 300*scale, h - 130*scale, ammoCol, TEXT_ALIGN_RIGHT, TEXT_ALIGN_BOTTOM, 1, outlineCol)
						if resclip and resclip > 0 then
							draw.SimpleTextOutlined(ammoTotal, ammofont, w - 220*scale, h - 120*scale, color_t7_ammo, TEXT_ALIGN_RIGHT, TEXT_ALIGN_BOTTOM, 1, color_t7_outline)
						end
					end
				else
					...
					if resclip and resclip > 0 then
						...
						surface.SetDrawColor(lowammo and (ColorAlpha(color_white, 100*flashing_sin)) or color_white_100)
						surface.DrawTexturedRect(w - 385*scale, h - 240*scale, 140*scale, 140*scale)

						local ammooffset = 0
						if ammolen >= 3 then ammooffset = 10 end
						draw.SimpleTextOutlined(ammoTotal, dafont, w - (295 - ammooffset)*scale, h - 130*scale, reserveCol, TEXT_ALIGN_RIGHT, TEXT_ALIGN_BOTTOM, 1, reserveoutCol)
					end
				end
			end
			...
			if wep.Secondary and (not wep.CanBeSilenced or (wep.CanBeSilenced and not wep:GetSilenced() and wep.Clip3)) then
				...
				if clip2 and clip2 > 0 then
					...
					draw.SimpleTextOutlined(wep:Clip2(), dafont, w - 385*scale, h - 130*scale, ammoCol, TEXT_ALIGN_RIGHT, TEXT_ALIGN_BOTTOM, 1, outlineCol)
				else
					if ammoTotal2 and ammoTotal2 > 0 then
						surface.SetMaterial(lowammo and t7_hud_ammo_glow_empty or t7_hud_ammo_glow)
						surface.SetDrawColor(lowammo and color_white_100 or color_white_100)
						surface.DrawTexturedRect(w - 475*scale, h - 240*scale, 140*scale, 140*scale)

						draw.SimpleTextOutlined(ammoTotal2, dafont, w - 385*scale, h - 130*scale, reserveCol, TEXT_ALIGN_RIGHT, TEXT_ALIGN_BOTTOM, 1, reserveoutCol)
					end
				end
			end
			...
			if wep.CanBeSilenced then
				...
				if ammoTotal2 > 0 then
					draw.SimpleTextOutlined(ammoTotal2, fontsmall, w - 180*scale, h - 130*scale, color_t7, TEXT_ALIGN_RIGHT, TEXT_ALIGN_BOTTOM, 1, color_t7_outline)
				end
			end
...
local function ZedCounterHUD_t7()
	...
	draw.SimpleTextOutlined(GetGlobal2Int("AliveZombies", 0), smallfont, wr + 36, h - (170*scale), color_t7, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER, 1, color_t7_outline)
end

-- Hooks
hook.Add("HUDPaint", "nzHUDswapping_t7_factory", function()
	if nzMapping.Settings.hudtype == "Der Riese Declassified" then
