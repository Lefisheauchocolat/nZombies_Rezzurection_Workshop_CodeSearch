...
function EFFECT:Init(data)
	...
	ParticleEffectAttach(self.Upgraded and "aw_magnetron_muzzleflash_2" or "aw_magnetron_muzzleflash", PATTACH_POINT_FOLLOW, self.WeaponEnt, self.Attachment)
end
...
function EFFECT:Think()
	...
	if IsValid(self.WeaponEnt) and dlight_cvar:GetBool() then
    	...
    	if (dlight) then
    		...
    		dlight.r = self.Upgraded and 255 or 140
    		dlight.g = self.Upgraded and 140 or 160
    		dlight.b = self.Upgraded and 140 or 255
    		dlight.brightness = 1
    		dlight.Decay = 4000
    		dlight.Size = 256
