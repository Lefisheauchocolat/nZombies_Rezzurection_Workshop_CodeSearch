...
function EFFECT:Init(data)
	...
	if self.IsViewModel then
		ParticleEffectAttach("aw_limbo_muzzleflash_2", PATTACH_POINT_FOLLOW, self.WeaponEnt, self.Attachment)
	else
		ParticleEffectAttach("aw_limbo_muzzleflash_3p_2", PATTACH_POINT_FOLLOW, self.WeaponEnt, self.Attachment)
	end
end
