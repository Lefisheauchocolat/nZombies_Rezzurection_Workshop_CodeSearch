...
function EFFECT:Init(data)
	...
	if not self.WeaponEntOG:IsCarriedByLocalPlayer() then
		self.WeaponEntOG:StopParticles()
	end

	ParticleEffectAttach("bo3_cng_muzzleflash", PATTACH_POINT_FOLLOW, self.WeaponEnt, self.Attachment)    
end
