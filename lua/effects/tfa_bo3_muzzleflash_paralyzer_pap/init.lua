...
function EFFECT:Init(data)
	...
	if self.WeaponEntOG:IsCarriedByLocalPlayer() && !LocalPlayer():ShouldDrawLocalPlayer() then
		ParticleEffectAttach("bo3_paralyzer_muzzleflash_pap", PATTACH_POINT_FOLLOW, self.WeaponEnt, self.Attachment)
	else
		ParticleEffectAttach("bo3_paralyzer_muzzleflash_3p_pap", PATTACH_POINT_FOLLOW, self.WeaponEnt, self.Attachment)
	end
end
