...
function EFFECT:Init(data)
	...
	self.WeaponEntOG:CleanParticles()
	...
	ParticleEffectAttach("bo4_alistairs_muzzleflash_3", PATTACH_POINT_FOLLOW, self.WeaponEnt, self.Attachment)
end
