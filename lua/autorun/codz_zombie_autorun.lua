...
sound.Add(
{
    name = "CoDZ_Barricade.Slam_Old",
    channel = CHAN_AUTO,
    volume = 1.10,
    soundlevel = 100,
    pitch = { 95, 105 },
    sound = {
        "nz_moo/barricade/slam/old/slam_00.mp3",
        "nz_moo/barricade/slam/old/slam_01.mp3",
        "nz_moo/barricade/slam/old/slam_02.mp3",
        "nz_moo/barricade/slam/old/slam_03.mp3",
        "nz_moo/barricade/slam/old/slam_04.mp3",
        "nz_moo/barricade/slam/old/slam_05.mp3",
    }
})
