...
------------------------------------------------------------------------------------------------------------------------------------
	...
	game.AddParticles("particles/demo_particle_light.pcf")
...
-- Alien Swarm --
	...
	game.AddParticles( "particles/mnb_fire.pcf" )
...
-- Misc --
	...
	"asw_barrel_rad_gas_cloud_warp",
	"asw_barrel_rad_gas_jet",
	"asw_flare_fx_glow",
	"asw_flare_fx_main",
	"asw_flare_fx_pulse2",
	"asw_flare_fx_smoke",
	"asw_freezer_droplets",
	"asw_freezer_smoke_2",
	"asw_freezer_spray",
	"asw_piercing_spark",
	"asw_piercing_spark_glow",
	"asw_piercing_spark_sparks_tight",
----------------------------------
-- Electric Weapon --
	"asw_electrc_weapon_arcs2",
	"asw_electric_weapon_continuous_TEST",
	"asw_electric_weapon_cp0",
	"asw_electric_weapon_cp1",
	"asw_electric_weapon_shot",
	"asw_electric_weapon_shot_continuous",
	"asw_electric_weapon_shot_continuous_off",
	"asw_electric_weapon_sprite_arcs",
	"asw_electric_weapon_zap",
	"asw_electric_weapon_zap_arcs",
	"asw_electric_weapon_zap_arcs_off",
	"asw_electric_weapon_zap_cp1",
	"asw_electric_weapon_zap_cp1_off",
	"asw_electric_weapon_zap_glows",
	"asw_electric_weapon_zap_muzzle",
	"asw_electric_weapon_zap_muzzle_off",
	"asw_electric_weapon_zap_start",
----------------------------------
-- Fire Extinguisher --
	"asw_fireextinguisher",
	"asw_fireextinguisher_cloud",
	"asw_fireextinguisher_droplets",
	"asw_fireextinguisher_mist",
	"asw_fireextinguisher_smoke_2",
	"asw_fireextinguisher_stream",
----------------------------------
-- Grenade --
	"asw_grenade_freeze_beam_trail",
	"asw_grenade_freeze_main_trail",
	"asw_grenade_freeze_pulse",
	"asw_grenade_freeze_trail1",
	"asw_grenade_freeze_trail2",
	"asw_grenade_glow",
	"asw_grenade_main_trail",
	"asw_grenade_radius",
	"asw_grenade_smoke",
	"asw_prifle_grenade_fx",
	"asw_prifle_grenade_smoke",
	"asw_prifle_grenade_sparks",
	"asw_prifle_grenade_trail",
	"asw_rifle_grenade_fx",
	"asw_rifle_grenade_pulse",
	"asw_rifle_grenade_smoke",
	"asw_rocket_trail_small",
	"asw_rocket_trail_small_flare",
	"asw_rocket_trail_small_glow",
----------------------------------
-- Laser Mine --
	"asw_laser_mine",
	"asw_laser_mine_friendly",
	"asw_mining_laser_beam",
	"asw_mining_laser_beam_b",
	"asw_mining_laser_beam_core",
	"asw_mining_laser_beam_cp0",
	"asw_mining_laser_beam_cp0_copy",
	"asw_mining_laser_beam_cp0_glow",
	"asw_mining_laser_beam_cp1_glow",
	"asw_mining_laser_charge_glows",
	"asw_mining_laser_charging",
	"asw_mining_laser_charging_cp0_glow",
	"asw_mining_laser_cp1_sparks",
	"asw_mining_laser_exhaust",
	"asw_mining_laser_start",
----------------------------------
-- Muzzleflash --
	"asw_muzzleflash_grenadelauncher_fire",
	"asw_muzzleflash_grenadelauncher_2",
	"asw_muzzleflash_grenadelauncher_glow",
	"asw_muzzleflash_grenadelauncher_main",
	"asw_muzzleflash_grenadelauncher_sparks",
	"asw_muzzleflash_grenadelauncher_sparks2",
----------------------------------
-- Reload --
	"asw_fast_reload",
	"asw_fast_reload_child_glow",
	"asw_fast_reload_child_glow2",
	"asw_reload_fail",
	"asw_reload_fail_flare",
	"asw_reload_fail_sparks",
	"asw_reload_fail_splash",
-----------------------------------
-- Tesla Trap --
	"asw_tesla_trap_fx",
	"asw_tesla_trap_fx_electric",
	"asw_tesla_trap_fx_glows",
	"asw_tesla_trap_fx_sparks",
	"asw_tesla_zap_fx",
	"asw_tesla_zap_fx_beam",
	"asw_tesla_zap_fx_cp0",
	"asw_tesla_zap_fx_cp1",
	"asw_tesla_zap_fx_start",
-----------------------------------
-- Laser Sights --
	"asw_weapon_laser_sight",
	"asw_weapon_laser_sight_FF",
	"asw_weapon_laser_sight_other",
-----------------------------------
-- Weapon Shells --
