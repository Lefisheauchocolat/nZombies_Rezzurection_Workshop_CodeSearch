...
ENT.Range = 100
ENT.Impacted = false
ENT.ImpactEffect = "bo2_raygun_impact"
...
function ENT:Initialize(...)
	...
	if self:GetUpgraded() then
		ParticleEffectAttach("bo2_raygun_trail_2", PATTACH_ABSORIGIN_FOLLOW, self, 0)
		self.ImpactEffect = "bo2_raygun_impact_2"
		self.color = Color(255, 40, 20)
	else
		ParticleEffectAttach("bo2_raygun_trail", PATTACH_ABSORIGIN_FOLLOW, self, 0)
		self.ImpactEffect = "bo2_raygun_impact"
