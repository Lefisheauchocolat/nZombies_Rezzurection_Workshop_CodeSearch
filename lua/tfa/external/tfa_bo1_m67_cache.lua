...
TFA.AddSound ("NZ.BO2.XM31.Fire", CHAN_ITEM, 1, SNDLVL_TALKING, 100, "nzr/2024/weapons/xm31/wpn_forearm_shot_plr.wav",")")
...
if engine.ActiveGamemode() == "nzombies" then
	hook.Add("PlayerButtonDown", "nzKOBEEE", function(ply, but)
		...
		if but == ply:GetInfoNum("nz_key_grenade", KEY_G) then
			local specials = ply.NZSpecialWeapons or {}
			local wep = specials["grenade"]
	...
	hook.Add("InitPostEntity", "nzfuckstuff", function()
		...
		nzSpecialWeapons:AddDisplay("tfa_zomdeath", false, function(wep)
			return IsValid(wep:GetOwner()) and wep:GetOwner():GetNotDowned()
		end)
