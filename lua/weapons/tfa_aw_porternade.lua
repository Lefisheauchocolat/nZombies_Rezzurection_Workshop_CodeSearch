...
SWEP.Slot = 4
SWEP.PrintName = nzombies and "Teleport Grenade | AW" or "Teleport Grenade"
...
--[Model]--
SWEP.ViewModel			= "models/weapons/tfa_aw/teleport_grenade/c_teleport_grenade.mdl"
SWEP.ViewModelFOV = 65
SWEP.WorldModel			= "models/weapons/tfa_aw/teleport_grenade/w_teleport_grenade.mdl"
...
--[Projectiles]--
SWEP.Primary.Round = nzombies and "nz_aw_tac_porternade" or "aw_tac_porternade"
SWEP.Primary.ProjectileModel = "models/weapons/tfa_aw/teleport_grenade/w_teleport_grenade.mdl"
SWEP.Velocity = 1500
...
SWEP.NZHudIcon = Material("vgui/icon/s1_hud_inventory_teleport_grenade.png", "unlitgeneric smooth")
SWEP.NZHudIcon_t7 = Material("vgui/icon/s1_hud_inventory_teleport_grenade_bw.png", "unlitgeneric smooth")
SWEP.NZHudIcon_t7tomb = Material("vgui/icon/s1_hud_inventory_teleport_grenade_bw.png", "unlitgeneric smooth")
