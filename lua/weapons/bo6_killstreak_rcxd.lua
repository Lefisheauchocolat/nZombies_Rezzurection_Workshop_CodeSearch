...
--[Model]--
SWEP.ViewModel = "models/nzr/2024/rccontroller/vm_t5_rccontroller.mdl"
SWEP.ViewModelFOV = 65
SWEP.WorldModel = "models/nzr/2024/rccontroller/world/wm_t5_rccontroller.mdl"
SWEP.HoldType = "slam"
...
[ACT_VM_DRAW] = {
    ...
    { ["time"] = 15 / 30, ["type"] = "sound", ["value"] = Sound("Latte_RCXD.Extend") },
    { ["time"] = 40 / 30, ["type"] = "lua", value = function(self)
        local ply = self:GetOwner()
        if !IsValid(ply) or !ply:Alive() then return end -- or !ply:GetNotDowned()

        ply:ScreenFade(SCREENFADE.IN, color_black, 1, 1)
        self:Remove()
        local ent = ents.Create("bo6_rcxd")
