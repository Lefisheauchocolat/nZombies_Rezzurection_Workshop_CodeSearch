...
SWEP.Slot = 0
SWEP.PrintName = "Trench Knife (WWII)"
...
SWEP.ViewModel = "models/weapons/tfa_codww2/trenchknife/c_katetrenchknife.mdl"
SWEP.WorldModel = "models/weapons/tfa_codww2/trenchknife/w_katetrenchknife.mdl"
SWEP.HoldType = "knife"
