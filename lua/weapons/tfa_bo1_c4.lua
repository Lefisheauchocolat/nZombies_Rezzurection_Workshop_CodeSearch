...
SWEP.Slot = 4
SWEP.PrintName = nzombies and "C4 | BO1" or "C4"
...
--[Model]--
SWEP.ViewModel			= "models/weapons/tfa_bo1/c4/c_c4.mdl"
SWEP.ViewModelFOV = 70
SWEP.WorldModel			= "models/weapons/tfa_bo1/c4/w_c4.mdl"
SWEP.HoldType = "slam"
...
SWEP.Primary.ProjectileModel = "models/weapons/tfa_bo1/c4/w_c4_projectile.mdl"
SWEP.Velocity = 550
...
SWEP.NZPaPName = "The Hyena Bomb"
SWEP.NZHudIcon = Material("vgui/icon/hud_t5_satchelcharge.png", "unlitgeneric smooth")
SWEP.NZHudIcon_t5 = Material("vgui/icon/hud_t5_satchelcharge.png", "unlitgeneric smooth")
SWEP.NZHudIcon_t6 = Material("vgui/icon/hud_t5_c4.png", "unlitgeneric smooth")
...
SWEP.NZDisplayDeploy = "nz_bo1_c4_detonate"
SWEP.IsC4 = true
...
self.nzPaPCamo = "models/weapons/tfa_bo1/c4/hyena_scroll.vmt"
self.WElements = {
	["detonator"] = { type = "Model", model = "models/weapons/tfa_bo1/c4/w_c4_detonator.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.5, 1.5, 1.5), angle = Angle(180, -20, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = self.nzPaPCamo, skin = 0, bonemerge = false, active = true, bodygroup = {} },
	["c4"] = { type = "Model", model = "models/weapons/tfa_bo1/c4/w_c4.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.5, 5, 1), angle = Angle(190, -60, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = self.nzPaPCamo, skin = 0, bonemerge = false, active = true, bodygroup = {} },
}
...
SWEP.WElements = {
	["detonator"] = { type = "Model", model = "models/weapons/tfa_bo1/c4/w_c4_detonator.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.5, 1.5, 1.5), angle = Angle(180, -20, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = true, bodygroup = {} },
	["c4"] = { type = "Model", model = "models/weapons/tfa_bo1/c4/w_c4.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.5, 5, 1), angle = Angle(190, -60, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = true, bodygroup = {} },
}
...
SWEP.C4KillEffect = "bo1_c4_hyena_electrocute"

function SWEP:PreDrawViewModel(vm, ...)
	BaseClass.PreDrawViewModel(self, vm, ...)

	if self.Ispackapunched then
		vm:SetSubMaterial(1, "models/weapons/tfa_bo1/c4/hyena_scroll.vmt")
		vm:SetSubMaterial(2, "models/weapons/tfa_bo1/c4/hyena_scroll.vmt")
	else
...
function SWEP:SecondaryAttack()
	...
	if self:GetStatus() ~= TFA.Enum.STATUS_C4_DETONATE then
		...
		self:ScheduleStatus(TFA.Enum.STATUS_C4_DETONATE, self:GetActivityLength() - (9/45))
		self:SetNextPrimaryFire(self:GetStatusEnd() - (9/45))
		return
	end
end
...
function SWEP:PreSpawnProjectile(ent)
	...
	if self.Ispackapunched then
		ent.nzPaPCamo = "models/weapons/tfa_bo1/c4/hyena_scroll.vmt"

		ent.ExplodeSound = "TFA_BO3_SCAVENGER.ExplodePAP"
		ent.FluxSound = "TFA_BO3_WAFFE.Flux"
		ent.RampupSound = "TFA_BO3_SCAVENGER.RampUp"
		ent.KillSound = "TFA_BO3_WAFFE.Zap"

		ent.KillEffect = self.C4KillEffect
		ent.ExplosionEffect = "bo1_c4_hyena_explode"
		ent.GroundEffect = "bo1_c4_hyena_ground"
	end
end
