...
SWEP.Slot = 0
SWEP.PrintName = "Diabolical but for Rich People"
...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_karambit_vm_moo.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_smr_karambit_wm.mdl"
SWEP.HoldType = "knife"
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_smr_karambit")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_smr_karambit", "vgui/killicons/tfa_mwr_smr_karambit", Color(255, 80, 0, 191))
end
