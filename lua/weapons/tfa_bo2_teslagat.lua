...
SWEP.Slot = 3
SWEP.PrintName = nzombies and "Tesla Gat | WAW" or "Tesla Gat"
SWEP.DrawCrosshair = true
SWEP.DrawCrosshairIS = false

--[Model]--
SWEP.ViewModel			= "models/weapons/tfa_bo2/teslagat/c_teslagat.mdl"
SWEP.ViewModelFOV = 65
SWEP.WorldModel			= "models/weapons/tfa_bo2/teslagat/w_teslagat.mdl"
...
SWEP.Primary.SoundLyr1 = "TFA_BO2_TESLAGAT.Act"
...
SWEP.MuzzleFlashEffect	= "tfa_bo2_muzzleflash_teslagat"
...
--[Projectile]--
SWEP.Primary.Projectile         = "bo2_ww_teslagat" -- Entity to shoot
SWEP.Primary.ProjectileVelocity = 3000 -- Entity to shoot's velocity
SWEP.Primary.ProjectileModel    = "models/weapons/tfa_bo2/teslagat/teslagat_projectile.mdl" -- Entity to shoot's model

--[Misc]--
SWEP.AmmoTypeStrings = {combinecannon = "#tfa.ammo.miscww.teslagat"}
...
--[NZombies]--
SWEP.NZPaPName = "Tonitruum Tormentum"
