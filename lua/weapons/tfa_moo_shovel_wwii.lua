...
SWEP.ViewModel = "models/weapons/tfa_codww2/shovel/c_kateshovel.mdl"
SWEP.WorldModel = "models/weapons/tfa_codww2/shovel/w_kateshovel.mdl"
SWEP.HoldType = "knife"
