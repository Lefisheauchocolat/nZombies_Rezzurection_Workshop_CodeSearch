...
SWEP.Slot = 4
SWEP.PrintName = nzombies and "Spikemore | BO1" or "Spikemore"
...
--[Projectiles]--
SWEP.Primary.Round = nzombies and "nz_bo1_tac_spikemore" or "bo1_tac_spikemore"
...
--[Misc]--
SWEP.InspectPos = Vector(0, -10, -12)
