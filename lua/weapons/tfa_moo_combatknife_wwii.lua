...
SWEP.Slot = 0
SWEP.PrintName = "US Combat Knife (WWII)"
...
SWEP.ViewModel = "models/weapons/tfa_codww2/combatknife/c_katecombatknife.mdl"
SWEP.WorldModel = "models/weapons/tfa_codww2/combatknife/w_katecombatknife.mdl"
SWEP.HoldType = "knife"
