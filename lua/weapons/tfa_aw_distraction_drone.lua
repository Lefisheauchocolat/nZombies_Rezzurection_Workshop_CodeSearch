...
SWEP.Slot = 4
SWEP.PrintName = nzombies and "Distraction Drone | AW" or "Distraction Drone"
...
--[Model]--
SWEP.ViewModel			= "models/weapons/tfa_aw/distraction_drone/c_distraction_drone.mdl"
SWEP.ViewModelFOV = 65
SWEP.WorldModel			= "models/weapons/tfa_aw/distraction_drone/w_distraction_drone.mdl"
SWEP.HoldType = "slam"
...
SWEP.Primary.Damage = nzombies and 1200 or 250
...
--[Projectiles]--
SWEP.Primary.Round = nzombies and "nz_aw_tac_distraction" or "aw_tac_distraction"
SWEP.Primary.ProjectileModel = "models/weapons/tfa_aw/distraction_drone/w_distraction_drone.mdl"
SWEP.Velocity = 1000
...
SWEP.NZPaPName = "Upgraded Distraction Drone"
SWEP.NZHudIcon = Material("vgui/icon/s1_hud_inventory_distraction_drone.png", "unlitgeneric smooth")
SWEP.NZHudIcon_t7 = Material("vgui/icon/s1_hud_inventory_distraction_drone_bw.png", "unlitgeneric smooth")
SWEP.NZHudIcon_t7tomb = Material("vgui/icon/s1_hud_inventory_distraction_drone_bw.png", "unlitgeneric smooth")
