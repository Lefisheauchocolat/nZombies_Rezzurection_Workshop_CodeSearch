...
SWEP.Slot = 1
SWEP.PrintName = "Mustang & Sally | Vanguard"
SWEP.DrawCrosshair = true
SWEP.DrawCrosshairIS = false

--[Model]--
SWEP.ViewModel			= "models/weapons/tfa_vg/mustangsally/c_mustangsally.mdl"
...
--[Gun Related]--
SWEP.Primary.Sound = "TFA_VANGUARD_MS.Shoot"
SWEP.Primary.SoundLayer1 = "TFA_VANGUARD_MS.Mech"
SWEP.Primary.SoundLayer2 = "TFA_VANGUARD_MS.Ext"
SWEP.Primary.SoundLayer3 = "TFA_VANGUARD_MS.Sub"
SWEP.Primary.SoundFlux = "TFA_BO3_MS.PapFlux"
SWEP.Secondary.Sound = "TFA_VANGUARD_MS.Shoot"
...
SWEP.SequenceLengthOverride = {
	[ACT_VM_RELOAD] = 67 / 30,
	[ACT_VM_RELOAD2] = 67 / 30,
	[ACT_VM_RELOAD_DEPLOYED] = 67 / 30,
}
...
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("TFA_BO3MS_FLY.Cloth") },
{ ["time"] = 5 / 30, ["type"] = "sound", ["value"] = Sound("TFA_BO3MS_FLY.Gear") },
{ ["time"] = 5 / 30, ["type"] = "sound", ["value"] = Sound("TFA_VANGUARD_MS.Right.Charge") },
{ ["time"] = 10 / 30, ["type"] = "sound", ["value"] = Sound("TFA_VANGUARD_MS.Left.Charge") },
},
[ACT_VM_RELOAD2] = {
{ ["time"] = 5 / 30, ["type"] = "sound", ["value"] = Sound("TFA_VANGUARD_MS.Right.MagOut") },
{ ["time"] = 30 / 30, ["type"] = "sound", ["value"] = Sound("TFA_VANGUARD_MS.Right.MagIn") },
{ ["time"] = 40 / 30, ["type"] = "sound", ["value"] = Sound("TFA_VANGUARD_MS.Right.Charge") },
},
[ACT_VM_RELOAD_DEPLOYED] = {
{ ["time"] = 5 / 30, ["type"] = "sound", ["value"] = Sound("TFA_VANGUARD_MS.Left.MagOut") },
{ ["time"] = 35 / 30, ["type"] = "sound", ["value"] = Sound("TFA_VANGUARD_MS.Left.MagIn") },
{ ["time"] = 50 / 30, ["type"] = "sound", ["value"] = Sound("TFA_VANGUARD_MS.Left.Charge") },
},
[ACT_VM_RELOAD] = {
{ ["time"] = 5 / 30, ["type"] = "sound", ["value"] = Sound("TFA_VANGUARD_MS.Right.MagOut") },
{ ["time"] = 5 / 30, ["type"] = "sound", ["value"] = Sound("TFA_VANGUARD_MS.Left.MagOut") },
