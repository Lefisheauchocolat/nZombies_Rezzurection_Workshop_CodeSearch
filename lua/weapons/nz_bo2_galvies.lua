...
SWEP.Author = "Wavy"
SWEP.Slot = 0
SWEP.PrintName = "Galvaknuckles | BO2"
...
--[Model]--
SWEP.ViewModel 			= "models/weapons/wavy_ports/bo2/c_galvies.mdl"
SWEP.ViewModelFOV = 65
SWEP.WorldModel 		= "models/weapons/wavy_ports/bo2/w_galvies.mdl"
SWEP.HoldType = "fist"
...
function SWEP:Equip(ply, ...)
	if nzombies then
		local wep = ply:Give('nz_bo2_galvies_display')
	end
