...
SWEP.Slot = 3
SWEP.PrintName = nzombies and "Acid Gat | BO2" or "Acid Gat"
SWEP.DrawCrosshair = true
SWEP.DrawCrosshairIS = false

--[Model]--
SWEP.ViewModel			= "models/weapons/tfa_bo2/acidgat/c_acidgat.mdl"
SWEP.ViewModelFOV = 65
SWEP.WorldModel			= "models/weapons/tfa_bo2/acidgat/w_acidgat.mdl"
...
--[Projectile]--
SWEP.Primary.Projectile         = "bo2_ww_acidgat" -- Entity to shoot
SWEP.Primary.ProjectileVelocity = 3000 -- Entity to shoot's velocity
SWEP.Primary.ProjectileModel    = "models/weapons/tfa_bo2/acidgat/acidgat_projectile.mdl" -- Entity to shoot's model
