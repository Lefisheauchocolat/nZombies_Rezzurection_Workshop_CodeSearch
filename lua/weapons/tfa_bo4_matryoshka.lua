...
SWEP.Slot = 5
SWEP.PrintName = nzombies and "Matryoshka Doll | BO4" or "матрёшка" 
...
--[Model]--
SWEP.ViewModel			= "models/weapons/tfa_bo4/matryoshka/c_matryoshka.mdl"
SWEP.ViewModelFOV = 70
SWEP.WorldModel			= "models/weapons/tfa_bo4/matryoshka/w_matryoshka.mdl"
...
--[Grenade]--
SWEP.Primary.Round = nzombies and "nz_bo4_tac_matryoshka" or "bo4_tac_matryoshka"
SWEP.Primary.ProjectileModel = "models/weapons/tfa_bo4/matryoshka/w_matryoshka.mdl"
SWEP.Velocity = 750
...
SWEP.NZHudIcon = Material("vgui/icon/hud_nesting_doll_bo4.png", "unlitgeneric smooth")
...
SWEP.EventTable = {
[ACT_VM_DRAW] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("TFA_BO4_DOLL.Raise") },
},
[ACT_VM_THROW] = {
...
function SWEP:OnRemove(...)
	self:StopSound("TFA_BO4_DOLL.Raise")
