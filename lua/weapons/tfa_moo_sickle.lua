...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_sickle_vm_moo.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_sickle_wm.mdl"
SWEP.HoldType = "melee"
...
SWEP.EventTable = {
	["h1_wpn_melee_sickle_inspect"] = {
		{time = 14 / 30, type = "sound", value = "yurie_h1.melee_sickle_ins_01"},
		{time = 35 / 30, type = "sound", value = "yurie_h1.melee_sickle_ins_02"},
		{time = 60 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_sickle_pullout_first"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.melee_sickle_pullout_first_01"},
		{time = 18 / 30, type = "sound", value = "yurie_h1.melee_sickle_pullout_first_02"},
		{time = 37 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_sickle_putaway"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.melee_putaway"},
	},
	["h1_wpn_melee_sickle_stab"] = {
		{time = 5 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
	},
	["h1_wpn_melee_sickle_swipe"] = {
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_sickle")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_sickle", "vgui/killicons/tfa_mwr_sickle", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.melee_sickle_","weapons/tfa_cod/mwr/h1_dlc_wpn/sickle/melee_sickle_"
