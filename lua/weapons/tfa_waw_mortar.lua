...
SWEP.Slot = 4
SWEP.PrintName = nzombies and "Mortar | WAW" or "Mortar"
...
--[Model]--
SWEP.ViewModel			= "models/weapons/tfa_waw/mortar/c_mortar.mdl"
SWEP.ViewModelFOV = 70
SWEP.WorldModel			= "models/weapons/tfa_waw/mortar/w_mortar.mdl"
...
SWEP.Primary.Damage = nzombies and 400 or 80
...
SWEP.Primary.ProjectileModel = "models/weapons/tfa_waw/mortar/w_mortar.mdl"
SWEP.Velocity = 750
...
SWEP.NZHudIcon = Material("vgui/icon/hud_mortar_shell.png", "unlitgeneric smooth")
...
SWEP.NZHudIcon_t7 = Material("vgui/icon/hud_t7_mortarshell.png", "unlitgeneric smooth")
SWEP.NZHudIcon_t7zod = Material("vgui/icon/hud_t7_mortarshell.png", "unlitgeneric smooth")
SWEP.NZHudIcon_t7tomb = Material("vgui/icon/hud_t7_mortarshell.png", "unlitgeneric smooth")
...
SWEP.EventTable = {
[ACT_VM_DRAW] = {
{ ["time"] = 1 / 30, ["type"] = "sound", ["value"] = Sound("TFA_WAW_ABNADE.Pin") },
},
[ACT_VM_THROW] = {
...
function SWEP:PostSpawnProjectile(ent)
	local angvel = Vector(0,math.random(-2000,2000),math.random(-2000,-8000)) //The positive z coordinate emulates the spin from a right-handed overhand throw
