...
SWEP.Slot = 4
SWEP.PrintName = nzombies and "Hunter Killer | BO2" or "Hunter Killer"
...
--[Model]--
SWEP.ViewModel			= nzombies and "models/weapons/tfa_bo2/hunterkiller/c_nzhunterkiller.mdl" or "models/weapons/tfa_bo2/hunterkiller/c_hunterkiller.mdl"
SWEP.ViewModelFOV = 65
SWEP.WorldModel			= "models/weapons/tfa_bo2/hunterkiller/w_hunterkiller.mdl"
...
--[Projectiles]--
SWEP.Primary.Round = nzombies and "nz_bo2_tac_hunterkiller" or "bo2_tac_hunterkiller"
SWEP.Primary.ProjectileModel = "models/weapons/tfa_bo2/hunterkiller/w_hunterkiller.mdl"
SWEP.Velocity = 500
...
SWEP.NZHudIcon = Material("vgui/icon/ks_menu_harpie_single_256.png", "unlitgeneric smooth")
...
{ ["time"] = 20 / 45, ["type"] = "lua", value = function(self)
	if nzombies then
		self:EmitSound("TFA_BO2_HKDRONE.Indentify")
	end
...
[ACT_VM_PULLPIN] = {
{ ["time"] = 1 / 45, ["type"] = "sound", ["value"] = Sound("weapon_bo3_cloth.short") },
{ ["time"] = 5 / 45, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gear.rattle") },
{ ["time"] = 10 / 45, ["type"] = "sound", ["value"] = Sound("TFA_BO2_HKDRONE.Indentify") },
},
[ACT_VM_THROW] = {
{ ["time"] = 1 / 30, ["type"] = "sound", ["value"] = Sound("TFA_BO3_GRENADE.Throw") },
},
}
