...
SWEP.Slot = 1
SWEP.PrintName = "Mustang & Sally | BO2"
SWEP.DrawCrosshair = true
SWEP.DrawCrosshairIS = false

--[Model]--
SWEP.ViewModel			= "models/weapons/tfa_bo2/mustangsally/c_mustangsally.mdl"
...
--[Gun Related]--
SWEP.Primary.Sound = "TFA_BO2_MS.Shoot"
SWEP.Primary.SoundLayer1 = "TFA_BO2_MS.Decay"
SWEP.Primary.SoundFlux = "TFA_BO2_MS.PapFlux"
SWEP.Secondary.Sound = "TFA_BO2_MS.Shoot"
...
SWEP.Primary.Sound_DryFire = "TFA_BO2MS_FLY.DryFire"
...
SWEP.StatusLengthOverride = {
	[ACT_VM_RELOAD] = 45 / 35,
	[ACT_VM_RELOAD2] = 45 / 35,
	[ACT_VM_RELOAD_DEPLOYED] = 45 / 35,
}
...
SWEP.EventTable = {
[ACT_VM_DRAW] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("TFA_BO2MS_FLY.Cloth") },
{ ["time"] = 5 / 60, ["type"] = "sound", ["value"] = Sound("TFA_BO2MS_FLY.Gear") },
},
[ACT_VM_HOLSTER] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("TFA_BO2MS_FLY.Cloth") },
{ ["time"] = 5 / 60, ["type"] = "sound", ["value"] = Sound("TFA_BO2MS_FLY.Gear") },
...
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("TFA_BO2MS_FLY.Cloth") },
{ ["time"] = 5 / 30, ["type"] = "sound", ["value"] = Sound("TFA_BO2MS_FLY.Gear") },
{ ["time"] = 15 / 30, ["type"] = "sound", ["value"] = Sound("TFA_BO2_MS.SlideFwd") },
{ ["time"] = 15 / 30, ["type"] = "sound", ["value"] = Sound("TFA_BO2_MS.SlideFwd") },
},
[ACT_VM_RELOAD2] = {
{ ["time"] = 10 / 35, ["type"] = "sound", ["value"] = Sound("TFA_BO2_MS.MagOut") },
{ ["time"] = 20 / 35, ["type"] = "sound", ["value"] = Sound("TFA_BO2_MS.Hammer") },
{ ["time"] = 40 / 35, ["type"] = "sound", ["value"] = Sound("TFA_BO2_MS.MagIn") },
{ ["time"] = 60 / 35, ["type"] = "sound", ["value"] = Sound("TFA_BO2_MS.SlideBack") },
{ ["time"] = 80 / 35, ["type"] = "sound", ["value"] = Sound("TFA_BO2_MS.SlideFwd") },
},
...
[ACT_VM_RELOAD] = {
{ ["time"] = 9 / 35, ["type"] = "sound", ["value"] = Sound("TFA_BO2_MS.MagOut") },
{ ["time"] = 10 / 35, ["type"] = "sound", ["value"] = Sound("TFA_BO2_MS.MagOut") },
{ ["time"] = 19 / 35, ["type"] = "sound", ["value"] = Sound("TFA_BO2_MS.Hammer") },
{ ["time"] = 20 / 35, ["type"] = "sound", ["value"] = Sound("TFA_BO2_MS.Hammer") },
{ ["time"] = 39 / 35, ["type"] = "sound", ["value"] = Sound("TFA_BO2_MS.MagIn") },
{ ["time"] = 40 / 35, ["type"] = "sound", ["value"] = Sound("TFA_BO2_MS.MagIn") },
{ ["time"] = 59 / 35, ["type"] = "sound", ["value"] = Sound("TFA_BO2_MS.SlideBack") },
{ ["time"] = 60 / 35, ["type"] = "sound", ["value"] = Sound("TFA_BO2_MS.SlideBack") },
{ ["time"] = 79 / 35, ["type"] = "sound", ["value"] = Sound("TFA_BO2_MS.SlideFwd") },
{ ["time"] = 80 / 35, ["type"] = "sound", ["value"] = Sound("TFA_BO2_MS.SlideFwd") },
},
}
