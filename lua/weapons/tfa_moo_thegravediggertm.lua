...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_tac_shovel_vm_moo.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_tac_shovel_wm.mdl"
SWEP.HoldType = "melee"
...
SWEP.EventTable = {
	["h1_wpn_melee_tac_shovel_inspect"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.shovel_inspect_start"},
		{time = 79 / 30, type = "sound", value = "yurie_h1.shovel_inspect_finish"},
		{time = 32 / 30, type = "sound", value = "yurie_h1.shovel_inspect_tap_1"},
		{time = 52 / 30, type = "sound", value = "yurie_h1.shovel_inspect_tap_2"},
		{time = 33 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 88 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 51 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
	},
	["h1_wpn_melee_tac_shovel_pullout"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.shovel_pullout"},
		{time = 12 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_tac_shovel_pullout_first"] = {
		{time = 4 / 30, type = "sound", value = "yurie_h1.shovel_pullout_first_start"},
		{time = 15 / 30, type = "sound", value = "yurie_h1.shovel_pullout_first_pull"},
		{time = 16 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 31 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 29 / 30, type = "sound", value = "yurie_h1.shovel_pullout_first_finish"},
	},
	["h1_wpn_melee_tac_shovel_putaway"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.shovel_putaway"},
		{time = 10 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_tac_shovel_stab"] = {
		{time = 5 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
	},
	["h1_wpn_melee_tac_shovel_swipe"] = {
...
SWEP.Primary.Attacks = {
	{
		...
		["dmgtype"] = DMG_SLASH,
		["delay"] = 4 / 30,
		["snd"] = "yurie_h1.shovel_swipe",
		["snd_delay"] = 0,
		["hitflesh"] = "yurie_h1.shovel_swipe_hit",
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_tac_shovel")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_tac_shovel", "vgui/killicons/tfa_mwr_tac_shovel", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.shovel_","weapons/tfa_cod/mwr/h1_dlc_wpn/shovel/shovel_"
	...
	TFA.AddSound(p1.."inspect_tap_1", CHAN_STATIC, 1, 75, 100, p2.."inspect_tap_1.ogg", ")")
	TFA.AddSound(p1.."inspect_tap_2", CHAN_STATIC, 1, 75, 100, p2.."inspect_tap_2.ogg", ")")
	...
	TFA.AddSound(p1.."pullout_first_pull", CHAN_STATIC, 1, 75, 100, p2.."pullout_first_pull.ogg", ")")
	...
	TFA.AddSound(p1.."stab", CHAN_STATIC, 1, 75, 100, {p2.."stab_start_01.ogg",p2.."stab_start_02.ogg"}, ")")
	TFA.AddSound(p1.."swipe", CHAN_STATIC, 1, 75, 100, {p2.."swipe_start_01.ogg",p2.."swipe_start_02.ogg"}, ")")
end
