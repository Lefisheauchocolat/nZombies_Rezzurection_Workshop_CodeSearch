...
SWEP.Slot = 3
SWEP.PrintName = nzombies and "V-R11 | BO1" or "V-R11"
...
--[Gun Related]--
SWEP.Primary.Sound = "TFA_BO3_VR11.Shoot"
...
SWEP.MuzzleFlashEffect	= "tfa_bo3_muzzleflash_vr11"
...
--[Projectile]--
SWEP.Primary.Projectile         = "bo3_ww_vr11" -- Entity to shoot
...
SWEP.MuzzleFlashEffectPAP = "tfa_bo3_muzzleflash_vr11_pap"

function SWEP:OnPaP()
self.Ispackapunched = true
self.Primary_TFA.ClipSize = 6
self.Primary_TFA.MaxAmmo = 24
self.MuzzleFlashEffect = "tfa_bo3_muzzleflash_vr11_pap"
self:ClearStatCache()
return true
end
...
{ ["time"] = 35 / 35, ["type"] = "lua", value = function(self) self:CustomParticlez() end, client = true, server = true},
...
function SWEP:CustomParticlez()
	...
	if IsFirstTimePredicted() then
		ParticleEffectAttach("bo3_vr11_vm_smoke", PATTACH_POINT_FOLLOW, self.OwnerViewModel, 2)
	end
end
