...
SWEP.Purpose = "BO1 right Zap Gun. \nFrom the World At War custom map 'Alcatraz' by TMG_Nukem"
SWEP.Author = "TMG_Nukem, FlamingFox"
SWEP.Slot = 1
SWEP.PrintName = nzombies and "Right Zap Gun | WAW" or "Right Zap Gun"
SWEP.DrawCrosshair = true
SWEP.DrawCrosshairIS = false

--[Model]--
SWEP.ViewModel			= "models/weapons/tfa_waw/zapgun/c_zapgun_rear.mdl"
SWEP.ViewModelFOV = 65
SWEP.WorldModel			= "models/weapons/tfa_waw/zapgun/w_zapgun_rear.mdl"
...
SWEP.MuzzleFlashEffect	= "tfa_bo3_muzzleflash_zapgun_right"
...
SWEP.IronSightsPos = Vector(-4.45, -2, 0.15)
...
[ACT_VM_RELOAD] = {
{ ["time"] = 5 / 30, ["type"] = "sound", ["value"] = Sound("TFA_BO1_MICROWAVE.Rear.Start") },
{ ["time"] = 35 / 30, ["type"] = "sound", ["value"] = Sound("TFA_BO1_MICROWAVE.Rear.End") },
},
}
...
function SWEP:PreDrawViewModel(vm, ...)
	...
	if self.Ispackapunched then
		...
		vm:SetSubMaterial(2, "models/weapons/tfa_waw/zapgun/bo1_mtl_zombie_teleporter_glow_red.vmt")
	else
